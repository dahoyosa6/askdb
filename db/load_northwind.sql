-- ─────────────────────────────────────────────────────────────
-- AskDB · Carga de la base de datos Northwind (Postgres)
-- Fuente canónica: https://github.com/pthom/northwind_psql (northwind.sql)
-- 14 tablas: categories, customers, employees, employee_territories, orders,
-- order_details, products, suppliers, shippers, region, territories, us_states,
-- customer_demographics, customer_customer_demo.
-- Cargar como 'postgres' (owner); el agente luego lee con el rol askdb_readonly.
-- ─────────────────────────────────────────────────────────────
--
